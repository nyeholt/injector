...
use November\Aspects\AfterCallAspect;
use November\Aspects\BeforeCallAspect;
use November\Aspects\AopProxyService;
 ...
 */
class AopProxyTest extends \PHPUnit_Framework_TestCase {
